...
class CoTAgent:
    def __init__(self,
                 ...
                 self_reflect_llm: AnyOpenAILLM = AnyOpenAILLM(**KWARGS),
                 action_llm: AnyOpenAILLM = AnyOpenAILLM(**KWARGS),
                 ) -> None:
...
class ReactAgent:
    def __init__(self,
                 ...
                 react_llm: AnyOpenAILLM = AnyOpenAILLM(**KWARGS),
                 ) -> None:
...
class ReactReflectAgent(ReactAgent):
    def __init__(self,
                 ...
                 docstore: Docstore = Wikipedia(),
                 react_llm: AnyOpenAILLM = AnyOpenAILLM(**KWARGS),
                 reflect_llm: AnyOpenAILLM = AnyOpenAILLM(**KWARGS),
                 ) -> None:
